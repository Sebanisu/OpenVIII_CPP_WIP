...
if (NOT tools_library_POPULATED)
    ...
    if (NOT EXISTS "${tools_library_SOURCE_DIR}")
        message(ERROR "${tools_library_SOURCE_DIR} does not exist!")
    endif ()
    if (NOT EXISTS "${tools_library_BINARY_DIR}")
        message(ERROR "${tools_library_BINARY_DIR} does not exist!")
    endif ()
