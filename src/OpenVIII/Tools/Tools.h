...
namespace OpenVIII {
struct [[maybe_unused]] Tools{ template<typename trivialType>[[maybe_unused]] static void ReadVal(std::istream & fp,
  trivialType &item){ static_assert(std::is_trivial_v<trivialType>);
...
*/
[[maybe_unused]] [[nodiscard]] constexpr static bool iEquals(const std::string_view &str1, const std::string_view &str2)
{
