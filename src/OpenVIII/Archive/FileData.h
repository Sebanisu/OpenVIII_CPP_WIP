...
public:
  ...
  [[nodiscard]] bool empty() const noexcept { return m_size == 0 || m_filename.empty(); }
  ...
  [[maybe_unused]] [[nodiscard]] auto get_path() const { return std::filesystem::path(m_filename); }
  ...
  //}
  // get size of file
  [[maybe_unused]] [[nodiscard]] constexpr auto size() const noexcept { return m_size; }
  [[maybe_unused]] [[nodiscard]] static constexpr auto compression_type() noexcept { return CompressionTypeT::none; }
  // alias for Size that should mirror FI
  [[maybe_unused]] [[nodiscard]] constexpr auto uncompressed_size() const noexcept { return m_size; }
  // get offset of file
  [[maybe_unused]] [[nodiscard]] constexpr auto offset() const noexcept { return m_offset; }
