...
/**
 * There maybe more than one Geometry checking for 01 00 01 00 to know if there is one or more
 */
struct Geometries
{
private:
  std::vector<Geometry> m_geometries{};// there is usually one. But can be more than 1.
