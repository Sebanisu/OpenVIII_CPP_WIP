...
#ifndef OPENVIII_CPP_WIP_DATTRIANGLE_HPP
#define OPENVIII_CPP_WIP_DATTRIANGLE_HPP
#include "FaceWrapper.hpp"
#include "open_viii/graphics/Point.hpp"
#include "TextureIDWrapper.hpp"
#include <array>
#include <cstdint>
...
static_assert(sizeof(DatTriangle) == DatTriangle::EXPECTED_SIZE);
}// namespace open_viii::battle::dat
#endif// OPENVIII_CPP_WIP_DATTRIANGLE_HPP
