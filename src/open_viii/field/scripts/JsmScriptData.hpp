...
struct [[maybe_unused]] std::tuple_size<
  open_viii::field::scripts::JsmScriptData> : std::integral_constant<size_t, 2U>
{
};
/**
 * type of argument 0
...
struct [[maybe_unused]] std::
  tuple_element<0U, open_viii::field::scripts::JsmScriptData>
{
...
template<>
struct [[maybe_unused]] std::
  tuple_element<1U, open_viii::field::scripts::JsmScriptData>
{
