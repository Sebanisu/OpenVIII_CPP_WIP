...
public:
   ...
   */
  [[nodiscard]] auto
    minus_8_num_red_bits() const noexcept
  {
   ...
   */
  [[nodiscard]] auto
    minus_8_num_green_bits() const noexcept
  {
   ...
   */
  [[maybe_unused]] [[nodiscard]] auto
    minus_8_num_blue_bits() const noexcept
  {
   ...
   */
  [[nodiscard]] auto
    minus_8_num_alpha_bits() const noexcept
  {
