...
PupuID
  UniquifyPupu::operator()(const is_tile auto &tile_const)
{
  const auto t           = 16;
...
template PupuID
  UniquifyPupu::operator()(const Tile1 &);
template PupuID
  UniquifyPupu::operator()(const Tile2 &);
template PupuID
  UniquifyPupu::operator()(const Tile3 &);
