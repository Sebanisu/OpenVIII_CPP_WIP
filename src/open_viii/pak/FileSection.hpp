...
public:
   ...
   */
  void
    file_name(std::string in_file_name) noexcept
  {
   ...
   */
  void
    frames(const std::uint32_t &in_frames) noexcept
  {
    m_frames = in_frames;
  }
  /**
   ...
   */
  void
    offset(const std::int64_t &in_offset) noexcept
  {
    m_offset = in_offset;
  }
  /**
   ...
   */
  void
    size(const std::uint32_t &in_size) noexcept
  {
    m_size = in_size;
  }
  /**
   ...
   */
  void
    type(const std::string_view &in_type) noexcept
  {
    m_type = in_type;
  }
  friend std::ostream &
