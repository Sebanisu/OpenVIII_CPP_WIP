...
namespace OpenVIII::Archive {
    ...
    public:
        ...
        [[nodiscard]] constexpr auto UncompressedSize() const {
            return uncompressedSize_;
        }

        [[nodiscard]] constexpr auto Offset() const {
            return offset_;
        }

        [[nodiscard]] constexpr auto CompressionType() const {
            return compressionType_;
        }

        constexpr FI() = default;

        constexpr FI(const unsigned int &uncompressedSize, const unsigned int &offset,
...
//        }
        ...
        [[nodiscard]] constexpr static auto GetCount(const size_t fileSize) {
        ...
        [[nodiscard]] static FI
        GetEntry(const std::filesystem::path &path, const unsigned int &id, const size_t &offset) {
